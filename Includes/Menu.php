            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                        ...
                        <span class="item-name">Leave Management</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo $Menu == "ManageEvents" ? "active" : "" ?>"
                                href="../Leave/ApplyLeave.php?Menu=ManageEvents">
                                <i class="icon">
                                ...
                                <span class="item-name"> Apply Leave </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $Menu == "ManageImages" ? "active" : "" ?>"
                                href="../Leave/ManageLeave.php?Menu=ManageImages">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
